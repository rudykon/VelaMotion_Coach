param([string]$BuildRoot='D:\wsl_ubuntu\app-work\velamotion_coach', [string]$Python='python')
...
& $Python (Join-Path $PSScriptRoot 'optimize-watch-styles.py') (Join-Path $BuildRoot 'src/pages/index/index.ux')
...
New-Item -ItemType Directory -Force (Join-Path $source 'dist') | Out-Null
