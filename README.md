...
当前提供 **黄山派开发验证版 `huangshan-20260923`**，镜像以大小与 SHA256 标识；当前仓库采用独立源码快照。

- [Release 页面与下载](https://github.com/rudykon/VelaMotion_Coach/releases/tag/huangshan-20260923)
- [完整固件 `velamotion-openvela.bin`](https://github.com/rudykon/VelaMotion_Coach/releases/download/huangshan-20260923/velamotion-openvela.bin)
- [SHA256 校验文件](https://github.com/rudykon/VelaMotion_Coach/releases/download/huangshan-20260923/SHA256SUMS.txt)
...
| [`docs/build_workspace.md`](docs/build_workspace.md) | 独立仓库与 openvela 工作区清单使用说明。 |
